    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('pedidos.update',$pedido->idPedido) }}" aria-label="{{ __('Editar Pedido') }}">
                    <input name="_method" type="hidden" value="PATCH">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="fecha_pedido" type="date" class="form-control{{ $errors->has('fecha_pedido') ? ' is-invalid' : '' }}" name="fecha_pedido" value="{{$pedido->fecha_pedido}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_entrega" type="date" class="form-control{{ $errors->has('fecha_entrega') ? ' is-invalid' : '' }}" name="fecha_entrega" value="{{$pedido->fecha_entrega}}" required>
